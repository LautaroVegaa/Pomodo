...
export const YearlyStats: React.FC<YearlyStatsProps> = ({ data, isLoading }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="dark:bg-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Promedio anual</p>
                <p className="text-xl font-bold text-gray-800 dark:text-white">
      ...
      <Card className="dark:bg-gray-700">
        <CardHeader>
          <CardTitle className="dark:text-white">Evolución anual</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="dark:bg-gray-700">
        <CardHeader>
          <CardTitle className="dark:text-white">Detalle por año</CardTitle>
        </CardHeader>
        <CardContent>

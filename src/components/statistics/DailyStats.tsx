...
export const DailyStats: React.FC<DailyStatsProps> = ({ data, isLoading }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="dark:bg-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Total semanal</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-800 dark:text-white">{totalWeekCycles}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="dark:bg-gray-700">
        <CardHeader>
          <CardTitle className="dark:text-white">Tiempo de estudio por día</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="dark:bg-gray-700">
        <CardHeader>
          <CardTitle className="dark:text-white">Detalle por día</CardTitle>
        </CardHeader>
        <CardContent>
